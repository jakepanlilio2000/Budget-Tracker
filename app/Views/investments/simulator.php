    ...
    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div class="card glass" style="border-top: 3px solid var(--accent);">
            ...
            <div class="grid grid-2 mt-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="a_inflation" value="3" min="0" max="20" step="0.1"
        ...
        <div class="card glass" id="scenarioB_wrap" style="border-top: 3px solid #8b5cf6; display: none;">
            <div class="flex-between">
                ...
                <button class="btn btn-sm" onclick="toggleScenarioB()"
                    style="background:transparent; color:var(--danger);">Remove</button>
            </div>
            <div class="grid grid-2 mt-3">
                <div class="form-group">
        ...
        <button class="btn" onclick="toggleScenarioB()" id="addScenarioBtn"
            style="background: rgba(139,92,246,0.1); color: #8b5cf6; border: 1px dashed #8b5cf6;">

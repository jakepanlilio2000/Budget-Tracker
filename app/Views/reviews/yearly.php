...
<div class="page-header flex-between" style="flex-wrap: wrap; gap: 1rem;">
    ...
    <div style="display: flex; gap: 0.5rem;">
        ...
        <a href="<?= url('/yearly-review/export-csv?year=' . $currentYear) ?>" class="btn"
            style="background: var(--text-secondary); color: white;"><i class="fas fa-file-csv"></i> Export CSV</a>
    </div>
</div>
...
<div class="grid grid-4 mb-4">
    ...
    <div class="card glass stat-card">
        <div class="stat-icon"
            style="background: <?= $r['net_income'] >= 0 ? 'rgba(16,185,129,0.15)' : 'rgba(239,68,68,0.15)' ?>; color: <?= $r['net_income'] >= 0 ? 'var(--success)' : 'var(--danger)' ?>;">
    ...
    <div class="card glass stat-card">
        <div class="stat-icon" style="background: rgba(139,92,246,0.15); color: #8b5cf6;"><i
...
<div class="grid grid-2">
    <div class="card glass">
        ...
        <div class="mt-3" style="display: flex; flex-direction: column; gap: 1rem;">
            <div class="flex-between"
                style="padding: 1rem; background: rgba(16,185,129,0.05); border-radius: 8px; border-left: 3px solid var(--success);">
                <div>
                ...
                <span class="sensitive-data"
                    style="font-weight: bold; color: var(--success);">+<?= $sym ?><?= number_format($r['best_month']['net'], 2) ?></span>
            </div>
            <div class="flex-between"
                style="padding: 1rem; background: rgba(239,68,68,0.05); border-radius: 8px; border-left: 3px solid var(--danger);">
                <div>
                    <small class="text-secondary">Worst Month (Lowest Surplus/Deficit)</small>
                    <h4 style="margin: 0;"><?= e($r['worst_month']['month']) ?></h4>
                </div>
                <span class="sensitive-data"
                    style="font-weight: bold; color: var(--danger);"><?= $sym ?><?= number_format($r['worst_month']['net'], 2) ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="card glass">
        ...
        <ul
            style="list-style: none; padding: 0; margin-top: 1rem; display: flex; flex-direction: column; gap: 0.75rem;">

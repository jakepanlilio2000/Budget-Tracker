...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px; align-items: start;">
    <div class="card">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
            <a href="<?= $basePath ?>/backups/<?= $profile['id'] ?>/excel" class="btn primary" style="text-align: center; display: block; background: #217346; border-color: #217346; box-shadow: 0 0 10px rgba(33, 115, 70, 0.5);">📊 Export Excel</a>
            <a href="<?= $basePath ?>/backups/<?= $profile['id'] ?>/json" class="btn ghost" style="text-align: center; display: block; border: 1px solid var(--border);">💻 Download as JSON (Dev Backup)</a>
        </div>
    </div>

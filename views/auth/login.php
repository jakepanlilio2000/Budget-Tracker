...
<div style="background: var(--bg-card); padding: 40px; border-radius: 16px; border: 1px solid var(--border); width: 100%; max-width: 400px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
    <div style="text-align: center; margin-bottom: 32px;">
        ...
        <p style="color: var(--text-secondary); font-size: 14px; margin-top: 8px;">Sign in to your financial command center.</p>
    </div>
    ...
    <form action="<?= $basePath ?>/login" method="POST">
        ...
        <button type="submit" class="btn primary" style="width: 100%; padding: 12px; font-size: 16px; margin-top: 16px;">Secure Login</button>
    </form>

    <div style="text-align: center; margin-top: 24px; font-size: 14px; color: var(--text-secondary);">
        Don't have an account? <a href="<?= $basePath ?>/register" style="color: var(--accent-blue); text-decoration: none;">Create one</a>
    </div>
</div>
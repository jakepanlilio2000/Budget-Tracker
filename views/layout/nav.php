...
<?php if (!$isLoggedIn): ?>
    <main class="main-content" style="margin-left: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh;">
<?php else: ?>
...
<div id="spa-workspace" style="width: 100%;">